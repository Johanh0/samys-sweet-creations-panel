...
const Home = () => {
  return (
    <div className=' w-full h-fit bg-gray-100 pl-60 pt-10 pr-10 pb-10'>
      ...
      <div className='flex justify-between gap-10 w-full h-96 '>
        ...
        <div className=' w-1/3 h-10'>
          ...
          <div className=' w-full h-72 bg-white rounded-xl shadow-sm'>
      ...
      <div className='flex justify-between gap-10 w-full h-96 '>
        <div className=' w-1/3 h-10'>
          <h2 className=' mb-5 font-medium text-gray-700'>Notas</h2>
          <div className=' w-full h-72 bg-white rounded-xl shadow-sm'>
        ...
        <div className=' w-1/3 h-10'>
          <h2 className=' mb-5 font-medium text-gray-700'>...</h2>
          <div className=' w-full h-72 bg-white rounded-xl shadow-sm'>
